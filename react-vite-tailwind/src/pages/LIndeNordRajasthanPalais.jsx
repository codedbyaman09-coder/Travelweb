          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            <div className="mb-12">
              <h2 className="text-[#000] font-serif text-[28px] md:text-[32px] font-bold mb-6 italic leading-tight">
                Rajasthan Royal Taj Mahal — 15 Jours
              </h2>
              <p className="text-[#000] font-['Montserrat'] leading-[1.8] text-[15px] max-w-3xl">
                Un voyage d'exception au cœur du Rajasthan royal, des ruelles animées de Delhi aux magnifiques palais d'Udaipur et au majestueux Taj Mahal. Plongez dans l'histoire des Maharajas, traversez le désert du Thar et découvrez des paysages à couper le souffle.
              </p>
            </div>
            <div className="space-y-4 mb-16">
              {[
                ...
                "day 5 — Jaisalmer & Désert du Thar",
                ...
                "day 14 — Bharatpur → Fatehpur Sikri → Agra",
                "day 15 — Agra → Delhi & Départ"
              ].map((day, index) => (
                <div
                  key={index}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600 italic">
                  <li>• L'hébergement de 14 nuits en chambre double de catégorie charme</li>
          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            ...
            <div className="space-y-8">
              <div className="bg-white border-l-4 border-[#b7772e] p-6 shadow-sm">
                ...
                <p className="text-gray-600 text-sm leading-relaxed italic">De octobre à mars</p>
              </div>
              <div className="bg-white border-l-4 border-[#b7772e] p-6 shadow-sm">
                <h4 className="font-bold text-[#102d45] mb-2 uppercase text-sm">Style du voyage</h4>
                <p className="text-gray-600 text-sm leading-relaxed italic">Grand circuit privé du Rajasthan entre patrimoine, désert et palais royaux</p>
              </div>
            </div>
          </div>
        );
      ...
      <section className="relative h-[500px] md:h-[650px] lg:h-[720px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center md: text-center w-full max-w-[1440px] mx-auto px-[40px]">
          <div className="max-w-[800px]">
            <h1 className="font-serif text-[46px] md:text-[62px] lg:text-[76px] leading-[1.1] text-white mb-8 drop-shadow-lg uppercase tracking-tight">Rajasthan Royal Taj Mahal — 15 Jours</h1>
            ...
            <p className="text-[14px] md:text-[16px] leading-relaxed text-white/90 max-w-[800px] mx-auto drop-shadow-md">
              Des palais raffinés de Jaipur aux ruelles bleues de Jodhpur, des dunes dorées du désert aux merveilles mogholes d’Agra, ce voyage vous plonge au cœur du Rajasthan éternel.
            </p>
          </div>
        </div>
      </section>
