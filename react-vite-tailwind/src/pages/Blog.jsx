  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen">
      ...
      <div className="relative h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12 max-w-4xl pt-48 md:pt-64">
          <div className="md:translate-x-72 lg:translate-x-[33rem] translate-y-48 md:translate-y-[20rem] animate-fadeInUp text-center max-w-2xl mx-auto" style={{ animationDelay: '200ms' }}>
          ...
          {posts.slice(0, visiblePosts).map((post, index) => {
            ...
            return (
              <CardComponent
                ...
                {...extraProps}
              >
                <div className="relative overflow-hidden aspect-[4/3] mb-8 shadow-sm">
                  <img
                    src={post.image}
                    alt={post.title}
