...
const FestivalsCouleursTraditionsIndiennes = () => {
  ...
  useEffect(() => {
    ...
    .then(([itinData, destData]) => {
      let itin = null;
      if (itinData.success) {
        itin = itinData.data.find(d => d.slug.replace(/-$/, '') === 'festivals-couleurs-traditions-indiennes');
      }

      let dest = null;
      if (destData.success) {
        dest = destData.data.find(d => d.slug.replace(/-$/, '') === 'festivals-couleurs-traditions-indiennes');
      }
  ...
  const defaultHighlights = [
    " Festivals & traditions indiennes",
    " Marchés colorés du Rajasthan",
    " Musique & danse folklorique",
    " Cuisine locale et expériences culturelles",
    " Pushkar & Varanasi spirituelle",
          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            <div className="mb-12">
              <h2 className="text-[#000] font-serif text-[28px] md:text-[32px] font-bold mb-6 italic leading-tight">
                {dynamicContent?.heroTitle || "Inde Festive — 14 Jours"} — {dynamicContent?.heroDuration ? (String(dynamicContent.heroDuration).toLowerCase().includes('jour') ? dynamicContent.heroDuration : `${dynamicContent.heroDuration} Jours`) : ""}
              </h2>
              <p className="text-[#000] font-['Montserrat'] leading-[1.8] text-[15px] max-w-3xl whitespace-pre-wrap">{dynamicContent?.heroDescription || "Un voyage vibrant au cœur des fêtes, des couleurs et des traditions de l’Inde. Des marchés illuminés du Rajasthan aux cérémonies sacrées, découvrez une Inde festive, authentique et profondément culturelle à travers ses musiques, danses, temples et célébrations."}</p>
            </div>
            <div className="space-y-4 mb-16">
              {(dynamicContent?.itinerary?.length > 0 && typeof dynamicContent.itinerary[0]?.title === 'string' && dynamicContent.itinerary[0].title.trim() !== "" ? dynamicContent.itinerary : [
                ...
                { day: "4", title: "Bikaner : Culture & Traditions" },
                { day: "5", title: "Bikaner → Jodhpur" },
                { day: "6", title: "Jodhpur : Musiques & Traditions" },
                { day: "7", title: "Jodhpur → Pushkar" },
                { day: "8", title: "Pushkar → Jaipur" },
                { day: "9", title: "Jaipur : Palais & Festivals" },
                { day: "10", title: "Jaipur → Agra" },
                { day: "11", title: "Agra → Varanasi" },
                { day: "12", title: "Varanasi : Spiritualité & Traditions" },
                { day: "13", title: "Varanasi → Delhi" },
                { day: "14", title: "Départ" }
              ]).map((item, index) => (
                <div
                  key={index}
        ...
        const defaultItinerary = [
          {
            day: "01", title: "Arrivée à Delhi", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une première rencontre vibrante avec l’Inde</p>
              </div>
            )
          },
          {
            day: "02", title: "Delhi → Mandawa", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une Inde traditionnelle et chaleureuse.</p>
              </div>
            )
          },
          {
            day: "03", title: "Mandawa → Bikaner", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Le Rajasthan authentique entre désert et traditions.</p>
              </div>
            )
          },
          {
            day: "04", title: "Bikaner : Culture & Traditions", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une immersion dans la culture du désert.</p>
              </div>
            )
          },
          {
            day: "05", title: "Bikaner → Jodhpur", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Couleurs et énergie du Rajasthan royal.</p>
              </div>
            )
          },
          {
            day: "06", title: "Jodhpur : Musiques & Traditions", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une ville vivante et profondément culturelle.</p>
              </div>
            )
          },
          {
            day: "07", title: "Jodhpur → Pushkar", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Entre spiritualité et traditions locales.</p>
              </div>
            )
          },
          {
            day: "08", title: "Pushkar → Jaipur", desc: (
              <div className="space-y-2">
          ...
          {
            day: "09", title: "Jaipur : Palais & Festivals", desc: (
              <div className="space-y-2">
                <p>• Fort d’Amber.</p>
                <p>• City Palace.</p>
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une journée festive au cœur du Rajasthan.</p>
              </div>
            )
          },
          {
            day: "10", title: "Jaipur → Agra", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Romantisme et héritage impérial.</p>
              </div>
            )
          },
          {
            day: "11", title: "Agra → Varanasi", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une Inde sacrée et fascinante.</p>
              </div>
            )
          },
          {
            day: "12", title: "Varanasi : Spiritualité & Traditions", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une immersion unique dans les traditions indiennes.</p>
              </div>
            )
          },
          {
            day: "13", title: "Varanasi → Delhi", desc: (
              <div className="space-y-2">
                <p>• Retour vers Delhi.</p>
                <p>• Temps libre.</p>
                <p>• Derniers achats artisanaux.</p>
                <p>• Dîner d’adieu indien.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Derniers instants dans l’ambiance festive de l’Inde.</p>
              </div>
            )
          },
          {
            day: "14", title: "Départ", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Fin de votre voyage culturel et festif en Inde.</p>
              </div>
            )
          },
        ];
        ...
        return (
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            ...
            <div className="bg-[#fcfcfc] border border-gray-100 p-8 mb-10">
              ...
              <p className="text-xs text-gray-400 italic">Prix basé on une occupation double, variable selon la saison et les disponibilités.</p>
            </div>
      ...
      <section className="relative h-[300px] md:h-[650px] lg:h-[720px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center w-full max-w-[1440px] mx-auto px-4 md:px-[40px] mt-8 md:mt-0">
          <div className="max-w-[800px]">
            <h1 className="font-serif text-[28px] md:text-[62px] lg:text-[76px] leading-[1.1] text-white mb-4 md:mb-8 drop-shadow-lg uppercase tracking-tight">{dynamicContent?.heroTitle || "Inde Festive 14 Jours"} {dynamicContent?.heroDuration || ""}</h1>
            ...
            <div className="hidden md:block bg-white border border-[#eadfce]/40 rounded-sm p-10 text-center shadow-[0_15px_45px_rgba(70,45,20,0.12)]">
              ...
              <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-6 mb-12">
                <div>
                  ...
                  <p className="text-[24px] font-bold text-[#102d45]">{dynamicContent?.price || "860€"}/pers</p>
                </div>
...
export default FestivalsCouleursTraditionsIndiennes;
