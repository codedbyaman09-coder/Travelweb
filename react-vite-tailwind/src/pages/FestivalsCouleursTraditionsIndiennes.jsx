          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            <div className="mb-12">
              <h2 className="text-[#000] font-serif text-[28px] md:text-[32px] font-bold mb-6 italic leading-tight">
                Inde Festive — 14 Jours
              </h2>
              <p className="text-[#000] font-['Montserrat'] leading-[1.8] text-[15px] max-w-3xl">
                Un voyage vibrant au cœur des fêtes, des couleurs et des traditions de l’Inde. Des marchés illuminés du
                Rajasthan aux cérémonies sacrées, découvrez une Inde festive, authentique et profondément culturelle à travers
                ses musiques, danses, temples et célébrations.
                .
              </p>
            </div>
          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border-l-4 border-[#b7772e] p-6 shadow-sm">
                ...
                <p className="text-gray-600 text-sm leading-relaxed italic">Voyage privé culturel et festif dédié aux voyageurs passionnés de traditions, de couleurs et
                  d’expériences authentiques.</p>
              </div>
            </div>
          </div>
        );
      ...
      <section className="relative h-[500px] md:h-[650px] lg:h-[720px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center md: text-center w-full max-w-[1440px] mx-auto px-[40px]">
          <div className="max-w-[800px]">
            <h1 className="font-serif text-[46px] md:text-[62px] lg:text-[76px] leading-[1.1] text-white mb-8 drop-shadow-lg uppercase tracking-tight">Inde Festive  14 Jours</h1>
            <div className="w-16 h-px bg-[#c58b32] mb-6 mx-auto" />
            <p className="text-[14px] md:text-[16px] leading-relaxed text-white/90 max-w-[800px] mx-auto drop-shadow-md">Un voyage vibrant au cœur des fêtes, des couleurs et des traditions de l’Inde. Des marchés illuminés du
              Rajasthan aux cérémonies sacrées, découvrez une Inde festive, authentique et profondément culturelle à travers
              ses musiques, danses, temples et célébrations.</p>
          </div>
        </div>
      </section>
