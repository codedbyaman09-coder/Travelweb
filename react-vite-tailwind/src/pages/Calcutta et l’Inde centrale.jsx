              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600 italic">
                  {(dynamicContent?.priceIncludes ? dynamicContent.priceIncludes.split('\n') : [
                      "• L'hébergement de 13 nuits en chambre double de catégorie charme",
                      "• Les petits-déjeuners gourmands",
                      "• Les transferts en véhicule privé climatisé avec chauffeur dévoué",
                      "• Toutes les visites, excursions et entrées mentionnées au programme (dont temples de Bhubaneswar)",
                      "• La découverte guidée du Temple du Soleil de Konark et des villages d'artisans d'Odisha"
  ...
  return (
    <div className="w-full min-h-screen bg-[#f7f3f0] overflow-x-hidden">
      ...
      <section className="relative h-[300px] md:h-[650px] lg:h-[720px] overflow-hidden">
        <img src={dynamicContent?.heroImage || "/src/assets/image copy 21.png"} alt="Kolkata, Odisha et Inde centrale" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center w-full max-w-[1440px] mx-auto px-4 md:px-[40px]">
          <div className="max-w-[800px] mt-8 md:mt-0">
            <h1 className="font-serif text-[24px] md:text-[62px] lg:text-[76px] leading-[1.1] text-white mb-2 md:mb-8 drop-shadow-lg uppercase tracking-tight">Kolkata, Odisha et Inde centrale — 14 Jours</h1>
