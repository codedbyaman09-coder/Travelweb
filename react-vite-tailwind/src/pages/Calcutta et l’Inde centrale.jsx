...
const LIndeNordRajasthanPalais = () => {
  ...
  const highlights = [
    "• Kolkata et héritage colonial bengali",
    "• Temples sacrés de l’Odisha",
    "• Architecture et sculptures de Bhubaneswar",
    "• Temple du Soleil de Konark",
    "• Puri et spiritualité hindoue",
    "• Villages artisanaux et tribaux",
    "• Rencontres authentiques hors des sentiers battus",
    "• Culture, art et traditions locales",
  ...
  const renderTabContent = () => {
    switch (activeTab) {
          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            <div className="mb-12">
              <h2 className="text-[#000] font-serif text-[28px] md:text-[32px] font-bold mb-6 italic leading-tight">
                Kolkata, Odisha et Inde centrale — 14 Jours
              </h2>
              <p className="text-[#000] font-['Montserrat'] leading-[1.8] text-[15px] max-w-3xl">
                Entre héritage colonial, temples sacrés, villages traditionnels et spiritualité indienne, Calcutta et l’Inde centrale offrent un voyage profondément humain et hors des sentiers battus.
              </p>
            </div>
            <div className="space-y-4 mb-16">
              {[
                "day 1 — Arrivée à Kolkata",
                "day 2 — Kolkata : Culture & Héritage Colonial",
                "day 3 — Kolkata : Spiritualité & Vie Locale",
                "day 4 — Kolkata → Bhubaneswar",
                "day 5 — Bhubaneswar & Temples Sacrés",
                "day 6 — Bhubaneswar → Puri",
                "day 7 — Puri & Villages Artisanaux",
                "day 8 — Puri → Konark → Gopalpur",
                "day 9 — Gopalpur → Villages Tribaux",
                "day 10 — Inde Tribale & Traditions Locales",
                "day 11 — Région Tribale → Raipur / Nagpur",
                "day 12 — Inde Centrale : Temples & Nature",
                "day 13 — Retour vers Kolkata",
                "day 14 — Départ"
              ].map((day, index) => (
                <div
                  key={index}
      ...
      case "EN DÉTAIL":
        const itinerary = [
          {
            day: "01", title: "Arrivée à Kolkata", desc: (
              <div className="space-y-2">
                <p>• Accueil personnalisé à l’aéroport.</p>
                <p>• Première découverte de Kolkata.</p>
                <p>• Quartiers coloniaux.</p>
                <p>• Marchés locaux.</p>
                <p>• Ambiance bengalie.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Bienvenue dans l’âme culturelle du Bengale.</p>
              </div>
            )
          },
          {
            day: "02", title: "Kolkata : Culture & Héritage Colonial", desc: (
              <div className="space-y-2">
                <p>• Victoria Memorial.</p>
                <p>• Howrah Bridge.</p>
                <p>• Flower Market.</p>
                <p>• College Street.</p>
                <p>• Cuisine bengalie et cafés historiques.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une ville artistique et profondément culturelle.</p>
              </div>
            )
          },
          {
            day: "03", title: "Kolkata : Spiritualité & Vie Locale", desc: (
              <div className="space-y-2">
                <p>• Temple de Kali à Kalighat.</p>
                <p>• Dakshineswar Temple.</p>
                <p>• Belur Math.</p>
                <p>• Balade sur les ghats du Gange.</p>
                <p>• Ferry local sur le fleuve.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une immersion spirituelle dans le Bengale.</p>
              </div>
            )
          },
          {
            day: "04", title: "Kolkata → Bhubaneswar", desc: (
              <div className="space-y-2">
                <p>• Vol ou train vers Bhubaneswar.</p>
                <p>• Découverte des temples anciens.</p>
                <p>• Vie locale.</p>
                <p>• Architecture hindoue.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Première immersion dans l’Inde sacrée de l’Est.</p>
              </div>
            )
          },
          {
            day: "05", title: "Bhubaneswar & Temples Sacrés", desc: (
              <div className="space-y-2">
                <p>• Temple de Lingaraj.</p>
                <p>• Mukteshwar Temple.</p>
                <p>• Rajarani Temple.</p>
                <p>• Marchés locaux.</p>
                <p>• Artisanat traditionnel.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Un patrimoine religieux exceptionnel.</p>
              </div>
            )
          },
          {
            day: "06", title: "Bhubaneswar → Puri", desc: (
              <div className="space-y-2">
                <p>• Dhauli Peace Pagoda.</p>
                <p>• Villages ruraux.</p>
                <p>• Temple de Jagannath.</p>
                <p>• Plage de Puri.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une ville sacrée emblématique de l’Inde.</p>
              </div>
            )
          },
          {
            day: "07", title: "Puri & Villages Artisanaux", desc: (
              <div className="space-y-2">
                <p>• Villages de peintres traditionnels.</p>
                <p>• Art du Pattachitra.</p>
                <p>• Rencontres locales.</p>
                <p>• Vie rurale d’Odisha.</p>
                <p>• Balade sur la plage.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Culture artisanale et authenticité locale.
</p>
              </div>
            )
          },
          {
            day: "08", title: "Puri → Konark → Gopalpur", desc: (
              <div className="space-y-2">
                <p>• Temple du Soleil de Konark.</p>
                <p>• Architecture classée UNESCO.</p>
                <p>• Côte sauvage d’Odisha.</p>
                <p>• Arrivée à Gopalpur-on-Sea.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Entre patrimoine et paysages marins.</p>
              </div>
            )
          },
          {
            day: "09", title: "Gopalpur → Villages Tribaux", desc: (
              <div className="space-y-2">
                <p>• Marchés tribaux.</p>
                <p>• Rencontres avec communautés locales.</p>
                <p>• Traditions ancestrales.</p>
                <p>• Vie rurale authentique.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une Inde rare et préservée.</p>
              </div>
            )
          },
          {
            day: "10", title: "Inde Tribale & Traditions Locales", desc: (
              <div className="space-y-2">
                <p>• Villages tribaux.</p>
                <p>• Artisanat local.</p>
                <p>• Cuisine traditionnelle.</p>
                <p>• Immersion culturelle.</p>
                <p>• Rencontres humaines.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une expérience profondément humaine.</p>
              </div>
            )
          },
          {
            day: "11", title: "Région Tribale → Raipur / Nagpur", desc: (
              <div className="space-y-2">
                <p>•• Route ou train vers l’Inde centrale. </p>
                <p>• Marchés locaux.</p>
                <p>• Vie quotidienne de l’Inde intérieure.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Transition vers l’Inde centrale authentique.</p>
              </div>
            )
          },
          {
            day: "12", title: "Inde Centrale : Temples & Nature", desc: (
              <div className="space-y-2">
                <p>• Temples anciens.</p>
                <p>• Villages traditionnels.</p>
                <p>• Nature rurale.</p>
                <p>• Spiritualité locale.</p>
                <p>• Temps libre et détente.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Entre histoire et traditions indiennes.</p>
              </div>
            )
          },
          {
            day: "13", title: "Retour vers Kolkata", desc: (
              <div className="space-y-2">
                <p>• Vol ou train retour.</p>
                <p>• Derniers achats.</p>
                <p>• Dîner d’adieu bengali. </p>
                <p>• Balade nocturne.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Derniers instants dans l’ambiance bengalie.</p>
              </div>
            )
          },
          {
            day: "14", title: "Départ", desc: (
              <div className="space-y-2">
                ...
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Fin de votre voyage culturel en Inde orientale.</p>
              </div>
            )
          },
        ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600 italic">
                  <li>• L'hébergement de 13 nuits en chambre double de catégorie charme</li>
                  <li>• Les petits-déjeuners gourmands</li>
                  <li>• Les transferts en véhicule privé climatisé avec chauffeur dévoué</li>
                  <li>• Toutes les visites, excursions et entrées mentionnées au programme (dont temples de Bhubaneswar)</li>
                  <li>• La découverte guidée du Temple du Soleil de Konark et des villages d'artisans d'Odisha</li>
                </ul>
              </div>
              <div>
          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border-l-4 border-[#b7772e] p-6 shadow-sm">
                ...
                <p className="text-gray-600 text-sm leading-relaxed italic">Voyage privé culturel et immersif entre spiritualité, villages traditionnels et patrimoine de l’Inde
orientale..</p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="w-full min-h-screen bg-[#f7f3f0] overflow-x-hidden">
      ...
      <section className="relative h-[500px] md:h-[650px] lg:h-[720px] overflow-hidden">
        <img src="/src/assets/image copy 21.png" alt="Kolkata, Odisha et Inde centrale" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center md: text-center w-full max-w-[1440px] mx-auto px-[40px]">
          <div className="max-w-[800px]">
            <h1 className="font-serif text-[46px] md:text-[62px] lg:text-[76px] leading-[1.1] text-white mb-8 drop-shadow-lg uppercase tracking-tight">Kolkata, Odisha et Inde centrale — 14 Jours</h1>
            ...
            <div className="bg-white border border-[#eadfce]/40 rounded-sm p-10 text-center shadow-[0_15px_45px_rgba(70,45,20,0.12)]">
              ...
              <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-6 mb-12">
                ...
                <div>
                  ...
                  <p className="text-[24px] font-bold text-[#102d45] whitespace-nowrap">14j / 13n</p>
                </div>
              </div>
