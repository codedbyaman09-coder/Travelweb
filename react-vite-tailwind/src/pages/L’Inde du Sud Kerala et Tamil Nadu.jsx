              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600 italic">
                  {(dynamicContent?.priceIncludes ? dynamicContent.priceIncludes.split('\n') : [
                      "• L'hébergement de 12 nuits en chambre double de catégorie charme",
                      "• Les petits-déjeuners gourmands",
                      "• Les transferts en véhicule privé climatisé avec chauffeur dévoué",
                      "• Toutes les visites, excursions et entrées mentionnées au programme (dont temple Meenakshi et Pondichéry)",
                      "• La croisière en houseboat privé dans les backwaters du Kerala"
  ...
  return (
    <div className="w-full min-h-screen bg-[#f7f3f0] overflow-x-hidden">
      ...
      <section className="relative h-[300px] md:h-[650px] lg:h-[720px] overflow-hidden">
        <img src={dynamicContent?.heroImage || "/src/assets/image copy 21.png"} alt="L’Inde du Sud Kerala et Tamil Nadu" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center w-full max-w-[1440px] mx-auto px-4 md:px-[40px]">
          <div className="max-w-[800px] mt-8 md:mt-0">
            <h1 className="font-serif text-[24px] md:text-[62px] lg:text-[76px] leading-[1.1] text-white mb-2 md:mb-8 drop-shadow-lg uppercase tracking-tight">L’Inde du Sud : Kerala et Tamil Nadu — 13 Jours</h1>
