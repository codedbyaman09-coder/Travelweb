  ...
  const features = [
    {
      ...
      text: "Nos spÃ©cialistes du voyage connaissent lâ€™Inde sur le bout des doigts et conÃ§oivent des itinÃ©raires fondÃ©s sur des expÃ©riences authentiques.",
      img: expertIcon,
    },
    {
      title: "Voyages Sur Mesure",
      text: "Chaque itinÃ©raire est conÃ§u autour de vos centres dâ€™intÃ©rÃªt, de votre style de voyage et de votre rythme.",
      img: CustomIcon,
    },
    {
      title: "Guides PrivÃ©s",
      text: "Profitez de visites enrichissantes avec des guides expÃ©rimentÃ©s, anglophones et francophones.",
      img: guideIcon,
    },
    {
      title: "Assistance Voyage 24h/24 Et 7j/7",
      text: "Notre Ã©quipe est disponible Ã  tout moment durant votre voyage pour vous garantir une expÃ©rience fluide et sans souci.",
      img: assistanceIcon,
    },
  ];
  ...
  const destinations = [
    {
      ...
      desc: "Capturez lâ€™Ã¢me de lâ€™Inde Ã  travers lâ€™objectif avec nos photographes experts.",
      img: img21,
      link: "/voyage-photo-expeditions",
    },
    {
      name: "Rajasthan Rural  Inde Authentique",
      desc: "Vivez au rythme des communautÃ©s locales pour une expÃ©rience humaine profonde.",
      img: img22,
      link: "/immersion-villages-indiens",
    },
    {
      name: "Rajasthan  Gujarat",
      desc: "DÃ©couvrez les techniques ancestrales des artisans indiens, du tissage Ã  la poterie.",
      img: img23,
      link: "/art-artisanat-savoir-faire",
    },
    {
      name: "Inde Spirituelle  Bien-ÃŠtre",
      desc: "Retrouvez lâ€™Ã©quilibre Ã  travers le yoga, la mÃ©ditation et les soins ayurvÃ©diques.",
      img: img24,
      link: "/spiritualite-yoga-ayurveda",
    },
    {
      name: "Inde Sauvage Tigres du Bengale",
      desc: "Observez le tigre du Bengale et la biodiversitÃ© exceptionnelle des parcs nationaux.",
      img: img25,
      link: "/safaris-vie-sauvage",
    },
    {
      name: "Rajasthan Romantique Kerala",
      desc: "CÃ©lÃ©brez votre union dans les dÃ©cors somptueux des palais de maharajas.",
      img: img26,
      link: "/lune-de-miel-escapades-romantiques",
    },
    {
      name: "Rajasthan, Gujarat  Inde Tribale",
      desc: "Explorez la diversitÃ© culturelle des peuples de lâ€™Inde et leurs traditions uniques.",
      img: img27,
      link: "/rencontres-ethniques-cultures-locales",
    },
    {
      name: "Leh, Nubra Valley  Pangong Lake",
      desc: "DÃ©passez vos limites dans les paysages grandioses des hautes altitudes.",
      img: img28,
      link: "/himalaya-aventures-hors-sentiers-battus",
    },
    {
      name: "Kerala Tropical  Houseboat Experience",
      desc: "Naviguez paisiblement sur les canaux tropicaux Ã  bord dâ€™un kettuvalam traditionnel.",
      img: img29,
      link: "/croisieres-backwaters-kerala",
    },
    {
      name: "Festivals, couleurs  traditions indiennes",
      desc: "Plongez dans lâ€™effervescence des plus grandes cÃ©lÃ©brations religieuses et culturelles.",
      img: img30,
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center md: text-center w-full max-w-[1440px] mx-auto px-[40px]">
          <div className="max-w-[800px]">
            ...
            <p className="text-[14px] md:text-[16px] leading-relaxed text-white/90 max-w-[500px] mx-auto drop-shadow-md">
              Des rÃ©gions fascinantes, des cultures uniques et des expÃ©riences
              inoubliables.
            </p>
          </div>
        </div>
        ...
        <div className="relative w-full h-[720px] overflow-hidden bg-white">
          ...
          <div className="absolute inset-0 grid grid-cols-7 pointer-events-none pl-[30px]">
            ...
            <Link
              ...
              className="flex flex-col items-center justify-start pt-[150px] text-center px-1 translate-x-[0px] pointer-events-auto group cursor-pointer"
            >
              <img
                src={archIcon}
                alt=""
              ...
              <p className="text-[7px] md:text-[9px] lg:text-[10px] text-[#462d14]/80 font-medium leading-tight max-w-[100px]">
                Palais majestueux, dÃ©serts dorÃ©s et hÃ©ritage royal.
              </p>
            </Link>
            ...
            <Link
              ...
              className="flex flex-col items-center justify-start pt-[150px] text-center px-1 pointer-events-auto group cursor-pointer"
            >
              <img
                src={nordIcon}
                alt=""
              ...
              <p className="text-[7px] md:text-[9px] lg:text-[10px] text-[#102d45]/80 font-medium leading-tight max-w-[100px]">
                Villes sacrÃ©es, traditions ancestrales et spiritualitÃ©.
              </p>
            </Link>
            ...
            <Link
              ...
              className="flex flex-col items-center justify-start pt-[150px] text-center px-1 -translate-x-[18px] pointer-events-auto group cursor-pointer"
            >
              <img
                src={keralaIcon}
                alt=""
            ...
            {/* Col 4: Map Space */}
            <div className="flex flex-col items-center justify-start pt-[150px] text-center px-1">
            ...
            <Link
              ...
              className="flex flex-col items-center justify-start pt-[150px] text-center px-1 translate-x-[35px] pointer-events-auto group cursor-pointer"
            >
              <img
                src={himalayaIcon}
                alt=""
            ...
            <Link
              ...
              className="flex flex-col items-center justify-start pt-[150px] text-center px-1 translate-x-[25px] pointer-events-auto group cursor-pointer"
            >
              <img
                src={sudIcon}
                alt=""
            ...
            >
              ...
              <p className="text-[7px] md:text-[9px] lg:text-[10px] text-[#0f3d3d]/80 font-medium leading-tight max-w-[100px]">
                Tribus, nature sauvage et trÃ©sors cachÃ©s.
              </p>
            </Link>
          </div>
        </div>
        ...
        <div className="w-full bg-[#fffaf2]/95 border-y border-[#eadfce]/50 px-6 md:px-12 lg:px-20 py-12 md:py-16">
          <div className="text-center max-w-[720px] mx-auto mb-8">
            <p className="text-[#c58b32] text-[10px] tracking-[0.28em] uppercase font-bold mb-2">
              Explorer lâ€™Inde autrement
            </p>

            <h2 className="font-serif text-[26px] md:text-[34px] leading-tight text-[#102d45] mb-3">
              Des destinations pour tous les rÃªves de voyage
            </h2>

            <p className="text-[12px] md:text-[13px] leading-6 text-[#102d45]/70">
              De la magie des palais du Rajasthan Ã  la sÃ©rÃ©nitÃ© du Kerala, de la
              spiritualitÃ© de Varanasi aux sommets de lâ€™Himalaya, chaque rÃ©gion
              de lâ€™Inde vous promet des Ã©motions uniques.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-5">
            {(dbDestinations.length > 0 ? dbDestinations.map(d => ({
              name: d.title,
              ...
              >
                <div className="h-[150px] md:h-[165px] overflow-hidden">
                  ...
                  />
                    ...
                    <div className="w-full h-full bg-[#eadfce] flex items-center justify-center text-[#c58b32] text-xs font-bold">No Image</div>
                  )}
                </div>
        ...
        <div className="grid lg:grid-cols-[330px_1fr] gap-5 w-full max-w-[1440px] mx-auto px-[40px]">
          <div className="bg-[#fffaf2] rounded-[12px] border border-[#eadfce] p-6 shadow-[0_8px_24px_rgba(70,45,20,0.06)]">
            ...
            <h2 className="font-serif text-[27px] md:text-[32px] leading-tight text-[#102d45] mb-4">
              Des voyages thÃ©matiques sur mesure
            </h2>

            <p className="text-[12px] leading-6 text-[#102d45]/70 mb-6">
              Envie dâ€™un voyage romantique, en famille, dâ€™un safari photo ou
              dâ€™un pÃ©riple spirituel ? Nous crÃ©ons des itinÃ©raires personnalisÃ©s
              selon vos envies.
            </p>
