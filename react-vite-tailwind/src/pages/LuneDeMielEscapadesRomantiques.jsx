          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            <div className="mb-12">
              <h2 className="text-[#000] font-serif text-[28px] md:text-[32px] font-bold mb-6 italic leading-tight">
                Rajasthan Romantique  Kerala — 14 Jours
              </h2>
              <p className="text-[#000] font-['Montserrat'] leading-[1.8] text-[15px] max-w-3xl">
                Un voyage imaginé pour les couples en quête d’émotions, de moments suspendus et d’expériences inoubliables.
            ...
            <div className="space-y-4 mb-16">
              {[
                ...
                "day 2 — Delhi → Udaipur",
                "day 3 — Udaipur : Palais & Romance",
                "day 4 — Udaipur → Jodhpur",
                "day 5 — Jodhpur → Désert du Thar",
                "day 6 — Désert → Jaipur",
                "day 7 — Jaipur : Palais & Traditions",
                "day 8 — Jaipur → Agra",
                "day 9 — Agra → Kochi",
                "day 10 — Kochi → Munnar",
                "day 11 — Munnar : Nature & Détente",
                "day 12 — Munnar → Alleppey",
          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border-l-4 border-[#b7772e] p-6 shadow-sm">
                ...
                <p className="text-gray-600 text-sm leading-relaxed italic">Voyage privé romantique dédié aux couples et lunes de miel</p>
              </div>
            </div>
          </div>
        );
      ...
      <section className="relative h-[500px] md:h-[650px] lg:h-[720px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1180px] mx-auto h-full flex flex-col items-center justify-center px-6 md:px-10 text-center">
          <div className="max-w-[800px]">
            ...
            <p className="text-[14px] md:text-[16px] leading-relaxed text-white/90 max-w-[800px] mx-auto drop-shadow-md">Un voyage imaginé pour les couples en quête d’émotions, de moments suspendus et d’expériences inoubliables.
              Entre palais royaux, dunes du Rajasthan, backwaters du Kerala et couchers de soleil romantiques, vivez une lune
              de miel élégante et profondément romantique en Inde.
            </p>
          </div>
