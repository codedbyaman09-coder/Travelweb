  ...
  const SpiritualVaranasi = () => {
    ...
    useEffect(() => {
      fetch('http://127.0.0.1:8000/api/blogs/spiritual-varanasi')
        .then(res => res.json())
        .then(data => {
          if (data.success && data.blog && data.blog.page_content) {
            try {
              setDynamicContent(JSON.parse(data.blog.page_content));
            } catch(e) {}
          }
        })
      ...
      <div className="bg-[#FAF9F6] min-h-screen font-light">
        ...
        <section className="relative h-[60vh] md:h-[75vh] lg:h-[85vh] overflow-hidden flex items-center justify-center">
          <div className="absolute inset-0 z-0">
            <img
              src={dynamicContent?.heroImage || "https://images.unsplash.com/photo-1561361513-2d000a50f0dc?auto=format&fit=crop&q=80&w=1600"}
              alt="Varanasi Gange"
          ...
          <div className="relative z-10 text-center text-white mt-16 md:mt-24 w-full max-w-[1440px] mx-auto px-[40px]">
            ...
            <h1 className="font-serif text-[32px] md:text-[50px] lg:text-[64px] leading-tight md:leading-[1.15] text-white uppercase tracking-wider mb-6 max-w-4xl mx-auto drop-shadow-md whitespace-pre-line">
            {dynamicContent?.heroTitle || `POURQUOI L’INDE CHANGE\nPROFONDÉMENT CEUX QUI LA\nDÉCOUVRENT`}
            </h1>
            ...
            {dynamicContent?.heroSubtitle || "Les Carnets d’Indeora — Une expérience émotionnelle et profondément humaine"}
            </p>
          </div>
        </section>
        ...
        <div className="relative z-25 md: -mt-4 md:-mt-8 mb-24 animate-fadeIn w-full max-w-[1440px] mx-auto px-[40px]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-3 lg:w-full lg:mx-auto">
              ...
              <div className="lg:mt-[347px]">
                <div className="relative overflow-hidden aspect-[4/5] bg-white shadow-2xl rounded-sm border border-gray-150 p-3 animate-fadeIn lg:max-w-[214px] mx-auto group cursor-pointer">
                  <img
                    src="https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&q=80&w=800"
                    alt="Rajasthan Royale Left Featured 2"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
