...
const RajasthanRoyale = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Nous recommandons généralement entre 10 et 15 jours afin de découvrir plusieurs villes sans précipitation."
    },
    {
      question: "Quelle est la meilleure période pour voyager au Rajasthan ?",
      answer: "La meilleure période se situe entre octobre et mars lorsque les températures sont les plus agréables"
    },
    {
      question: "Le Rajasthan est-il adapté pour un premier voyage en Inde ?",
      answer: "Oui, le Rajasthan est souvent la meilleure région pour découvrir l’Inde grâce à sa richesse culturelle et à la diversité de ses paysages."
    },
    {
    ...
    <div className="bg-[#FAF9F6] min-h-screen font-light">
      ...
      <div className="relative z-25 max-w-[1350px] mx-auto px-4 md:px-6 -mt-4 md:-mt-8 mb-24 animate-fadeIn">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-3 lg:max-w-[250px] lg:w-full lg:mx-auto">
