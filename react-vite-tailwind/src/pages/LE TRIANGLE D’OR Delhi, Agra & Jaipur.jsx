...
const LIndeNordRajasthanPalais = () => {
  ...
  const highlights = [
    "• Delhi entre tradition et modernité",
    "• Jaipur la ville rose du Rajasthan",
    "• Fort d’Amber & palais royaux",
    "• Marchés colorés & artisanat indien",
    "• Fatehpur Sikri & héritage moghol",
    ...
    switch (activeTab) {
        ...
        return (
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            ...
            <div className="space-y-4 mb-16">
              {[
                "day 1 — Arrivée à Delh",
                "day 2 — Delhi : Entre Ancien & Nouveau Monde",
                "day 3 — Delhi → Jaipur",
                "day 4 — Jaipur : Palais & Traditions",
                "day 5 — Jaipur : Vie Locale & Culture",
                "day 6 — Jaipur → Fatehpur Sikri → Agra",
                "day 7 — Agra : Taj Mahal & Héritage Moghol",
                "day 8 — Agra → Delhi & Départ"
              ].map((day, index) => (
                <div
                  key={index}
      ...
      case "EN DÉTAIL":
        const itinerary = [
          ...
          {
            day: "02", title: "Delhi : Entre Ancien & Nouveau Monde", desc: (
              <div className="space-y-2">
                <p>• Jama Masjid.</p>
                <p>• Chandni Chowk.</p>
                <p>• Marché aux épices.</p>
                <p>• Balade en rickshaw.</p>
                <p>• India Gate.</p>
                <p>• Qutub Minar.</p>
                <p>• Tombeau d’Humayun.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une ville fascinante entre histoire et modernité.</p>
              </div>
            )
          },
          {
            day: "03", title: "Delhi → Jaipur", desc: (
              <div className="space-y-2">
                <p>• Route vers Jaipur.</p>
                <p>• Découverte du Hawa Mahal.</p>
                <p>• Bazars colorés.</p>
                <p>• Vieille ville rose.</p>
                <p>• Dîner traditionnel ou rooftop.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Premiers instants dans le Rajasthan royal.</p>
              </div>
            )
          },
          {
            day: "04", title: "Jaipur : Palais & Traditions", desc: (
              <div className="space-y-2">
                <p>• Fort d’Amber.</p>
                <p>• Jal Mahal.</p>
                <p>• City Palace.</p>
                <p>• Jantar Mantar.</p>
                <p>• Atelier d’impression textile.</p>
                <p>• Artisanat traditionnel.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Le Rajasthan dans toute son élégance.</p>
              </div>
            )
          },
          {
            day: "05", title: "Jaipur : Vie Locale & Culture", desc: (
              <div className="space-y-2">
                <p>• Marchés traditionnels.</p>
                <p>• Cuisine rajasthanie.</p>
                <p>• Quartiers anciens.</p>
                <p>• Temps libre dans les bazars.</p>
                <p>• Option spectacle de danse traditionnelle.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Une immersion vivante dans la culture locale.</p>
              </div>
            )
          },
          {
            day: "06", title: "Jaipur → Fatehpur Sikri → Agra", desc: (
              <div className="space-y-2">
                <p>• Visite de Fatehpur Sikri.</p>
                <p>• Palais impériaux moghols.</p>
                <p>• Architecture historique.</p>
                <p>• Arrivée à Agra.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Entre patrimoine moghol et histoire impériale.</p>
              </div>
            )
          },
          {
            day: "07", title: "Agra : Taj Mahal & Héritage Moghol", desc: (
              <div className="space-y-2">
                <p>• Visite du Taj Mahal au lever du soleil.</p>
                <p>• Fort Rouge d’Agra.</p>
                <p>• Jardins moghols.</p>
                <p>• Artisanat du marbre.</p>
                <p>• Temps libre avec vue sur le Taj Mahal.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Le symbole éternel de l’amour en Inde.</p>
              </div>
            )
          },
          {
            day: "08", title: "Agra → Delhi & Départ", desc: (
              <div className="space-y-2">
                <p>• Retour vers Delhi.</p>
                <p>• Derniers achats.</p>
                <p>• Temps libre.</p>
                <p>• Transfert vers l’aéroport.</p>
                <p className="mt-6 font-medium italic text-[#102d45] text-[16px]">Fin de votre voyage Triangle d’Or.</p>
              </div>
            )
          },
        ...
        return (
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="text-3xl font-serif font-bold text-[#102d45]">825€</span>
              </div>
            ...
            <div className="bg-white border border-[#eadfce]/40 rounded-sm p-10 text-center shadow-[0_15px_45px_rgba(70,45,20,0.12)]">
              ...
              <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-6 mb-12">
                <div>
                  ...
                  <p className="text-[24px] font-bold text-[#102d45]">825€/pers</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-[24px] font-bold text-[#102d45] whitespace-nowrap">8j / 7n</p>
                </div>
              </div>
