        ...
        return (
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            ...
            <div className="space-y-4 mb-16">
              {[
                "day 1 — Arrivée à Kochi ",
                "day 2 — Kochi : Culture & Vie Locale",
                "day 3 — Kochi → Munnar",
                "day 4 — Munnar : Nature & Plantations",
                "day 5 — Munnar → Thekkady",
                "day 6 — Thekkady : Nature & Épices",
                "day 7 — Thekkady → Alleppey",
                "day 8 — Croisière dans les Backwaters",
                "day 9 — Alleppey → Kumarakom",
                "day 10 — Kumarakom → Marari Beach",
                "day 11 — Marari Beach : Journée Libre",
                "day 12 — Marari → Kochi",
                "day 13 — Départ",
              ].map((day, index) => (
                <div
      ...
      <section className="relative h-[500px] md:h-[650px] lg:h-[720px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1180px] mx-auto h-full flex flex-col items-center justify-center px-6 md:px-10 text-center">
          <div className="max-w-[800px]">
            <h1 className="font-serif text-[46px] md:text-[62px] lg:text-[76px] leading-[1.1] text-white mb-8 drop-shadow-lg uppercase tracking-tight">Kerala Tropical  Houseboat 13 Jours</h1>
            <div className="w-16 h-px bg-[#c58b32] mb-6 mx-auto" />
            <p className="text-[14px] md:text-[16px] leading-relaxed text-white/90 max-w-[800px] mx-auto drop-shadow-md">Un voyage au rythme lent du Kerala, entre nature luxuriante, villages paisibles, Ayurveda et célèbres backwaters.
              Découvrez une Inde tropicale et apaisante à travers des croisières privées, des plantations de thé, des plages
              bordées de cocotiers et une immersion authentique dans la vie locale du sud de l’Inde.</p>
          </div>
        </div>
      </section>
