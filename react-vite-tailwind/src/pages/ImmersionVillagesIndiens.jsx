          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            <div className="mb-12">
              <h2 className="text-[#000] font-serif text-[28px] md:text-[32px] font-bold mb-6 italic leading-tight">
                Rajasthan Rural  Inde Authentique — 13 Jours
              </h2>
              <p className="text-[#000] font-['Montserrat'] leading-[1.8] text-[15px] max-w-3xl">
                Un voyage hors du temps au cœur de l’Inde rurale. Vivez au rythme des villages du Rajasthan, partagez le
                quotidien des communautés locales et découvrez une hospitalité authentique pour une immersion humaine profonde
                et mémorable.
              </p>
            </div>
            <div className="space-y-4 mb-16">
              {[
                ...
                "day 4 — Villages autour de Bikaner",
                "day 5 — Bikaner → Khimsar",
                "day 6 — Khimsar → Jodhpur",
                "day 7 — Villages Bishnoï & Vie Rurale",
                "day 8 — Jodhpur → Pushkar",
                "day 9 — Pushkar → Jaipur",
                "day 10 — Villages autour de Jaipur",
                "day 11 — Jaipur → Agra",
                "day 12 — Agra → Delhi",
                "day 13 — Départ",
              ].map((day, index) => (
          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border-l-4 border-[#b7772e] p-6 shadow-sm">
                ...
                <p className="text-gray-600 text-sm leading-relaxed italic">Voyage privé et immersif dédié aux voyageurs en quête d’authenticité et de rencontres locales.</p>
              </div>
            </div>
          </div>
        );
      ...
      <section className="relative h-[500px] md:h-[650px] lg:h-[720px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1180px] mx-auto h-full flex flex-col items-center justify-center px-6 md:px-10 text-center">
          <div className="max-w-[800px]">
            <h1 className="font-serif text-[46px] md:text-[62px] lg:text-[76px] leading-[1.1] text-white mb-8 drop-shadow-lg uppercase tracking-tight">Rajasthan Rural  Inde Authentique 13 Jours</h1>
            <div className="w-16 h-px bg-[#c58b32] mb-6 mx-auto" />
            <p className="text-[14px] md:text-[16px] leading-relaxed text-white/90 max-w-[800px] mx-auto drop-shadow-md">Un voyage pensé pour les voyageurs en quête d’authenticité, de rencontres humaines et d’expériences locales
              loin des itinéraires classiques. Entre villages traditionnels, marchés ruraux, temples anciens et vie quotidienne,
              découvrez une Inde chaleureuse, vivante et profondément humaine.
            </p>
          </div>
        </div>
      </section>
