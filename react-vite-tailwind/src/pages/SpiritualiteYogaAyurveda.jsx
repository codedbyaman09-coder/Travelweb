          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            <div className="mb-12">
              <h2 className="text-[#000] font-serif text-[28px] md:text-[32px] font-bold mb-6 italic leading-tight">
                Inde Spirituelle  Bien-Être — 14 Jours
              </h2>
              <p className="text-[#000] font-['Montserrat'] leading-[1.8] text-[15px] max-w-3xl">
                Un voyage conçu pour ralentir, respirer et se reconnecter à soi-même à travers les traditions spirituelles de l’Inde.
                Des rives sacrées du Gange aux retraites ayurvédiques du Kerala, vivez une expérience apaisante mêlant
                spiritualité, yoga, méditation et bien-être.
              </p>
            </div>
            <div className="space-y-4 mb-16">
              {[
                ...
                "day 3 — Rishikesh : Yoga & Méditation",
                "day 4 — Rishikesh : Spiritualité Himalayenne",
                "day 5 — Rishikesh → Delhi → Varanasi",
                "day 6 — Varanasi : Spiritualité du Gange",
                "day 7 — Varanasi → Kochi",
                "day 8 — Kochi → Kerala Ayurvédique",
                "day 9 — Ayurveda & Yoga",
                "day 10 — Ayurveda & Relaxation",
          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border-l-4 border-[#b7772e] p-6 shadow-sm">
                ...
                <p className="text-gray-600 text-sm leading-relaxed italic">Voyage privé et apaisant dédié au bien-être, à la spiritualité et à la reconnexion intérieure</p>
              </div>
            </div>
          </div>
        );
      ...
      <section className="relative h-[500px] md:h-[650px] lg:h-[720px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1180px] mx-auto h-full flex flex-col items-center justify-center px-6 md:px-10 text-center">
          <div className="max-w-[800px]">
            <h1 className="font-serif text-[46px] md:text-[62px] lg:text-[76px] leading-[1.1] text-white mb-8 drop-shadow-lg uppercase tracking-tight">Inde Spirituelle  Bien-Être 14 Jours</h1>
            <div className="w-16 h-px bg-[#c58b32] mb-6 mx-auto" />
            <p className="text-[14px] md:text-[16px] leading-relaxed text-white/90 max-w-[800px] mx-auto drop-shadow-md">Un voyage conçu pour ralentir, respirer et se reconnecter à soi-même à travers les traditions spirituelles de l’Inde.
              Des rives sacrées du Gange aux retraites ayurvédiques du Kerala, vivez une expérience apaisante mêlant
              spiritualité, yoga, méditation et bien-être.
