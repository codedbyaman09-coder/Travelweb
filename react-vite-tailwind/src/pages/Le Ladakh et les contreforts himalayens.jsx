            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600 italic">
                  <li>• L'hébergement de 14 nuits en chambre double de catégorie charme et campements de luxe</li>
                  <li>• Les petits-déjeuners gourmands</li>
                  <li>• Les transferts en véhicule privé type SUV de montagne avec chauffeur dévoué</li>
                  <li>• Toutes les visites, excursions et entrées de monastères mentionnées au programme</li>
                  <li>• Les permis d'accès spéciaux (Inner Line Permits) pour les zones réglementées</li>
                </ul>
              </div>
              <div>
          ...
          <div className="pt-12 pb-16 px-6 md:px-12 lg:px-16 animate-fadeIn">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border-l-4 border-[#b7772e] p-6 shadow-sm">
                ...
                <p className="text-gray-600 text-sm leading-relaxed italic">Voyage privé et aventure himalayenne entre spiritualité, grands paysages et culture tibétaine.</p>
              </div>
            </div>
          </div>
        );
      ...
      <section className="relative h-[500px] md:h-[650px] lg:h-[720px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center md: text-center w-full max-w-[1440px] mx-auto px-[40px]">
          <div className="max-w-[800px]">
            <h1 className="font-serif text-[46px] md:text-[62px] lg:text-[76px] leading-[1.1] text-white mb-8 drop-shadow-lg uppercase tracking-tight">Leh, Nubra Valley, Pangong Lake Tso Moriri — 15 Jours</h1>
